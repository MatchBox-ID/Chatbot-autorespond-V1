...
│➛ Exp : ${explimit}
│➛ Limit : ${limit}
│➛ Tipe : ${type:premium![yes]/type:gratisan[No]
...
${footerTeks{=Matchbox Official Chatbot AI![type=footerTeks
${buttonlink{=Rest-Api}![type=https://matchbox.vercel.app
${buttontext1{=🄾🅆🄽🄴🅁}![type=text
${buttontext2{=🄻🄸🅂🅃 🄼🄴🄽🅄}!{type=text
